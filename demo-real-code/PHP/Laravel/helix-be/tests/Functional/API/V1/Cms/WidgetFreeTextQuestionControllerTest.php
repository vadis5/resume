<?php
/**
 * Widget Free Text Question Test Coverage
 */
...
class WidgetFreeTextQuestionControllerTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->seed(Seeders\TestWidgetFreeTextQuestionSeeder::class);
    }
    ...
    public function testIndexForSuperAdmin(): void
    {
        ...
        // Request
        $response = $this->get('api/cms/v1/widgetFreeTextQuestion?token=' . $token);
    ...
    public function testIndexEmptyResultForSuperAdmin()
    {
        ...
        $this->delete('api/cms/v1/widgetFreeTextQuestion/4?token=' . $token);
        $this->delete('api/cms/v1/widgetFreeTextQuestion/3?token=' . $token);
        $this->delete('api/cms/v1/widgetFreeTextQuestion/2?token=' . $token);
        $this->delete('api/cms/v1/widgetFreeTextQuestion/1?token=' . $token);
    ...
    {
        // Request
        $response = $this->get('api/cms/v1/widgetFreeTextQuestion');
    ...
    public function testCreateForSuperAdmin()
    {
        ...
        $response = $this->post('api/cms/v1/widgetFreeTextQuestion?token=' . $token, $data);
        ...
        $this->assertEquals(100, $data['character_limit']);
    }
    ...
    public function testCreateWrongDataForSuperAdmin()
    {
        ...
        $response = $this->post('api/cms/v1/widgetFreeTextQuestion?token=' . $token, self::STORE_DATA_INVALID);
    ...
    public function testCreateForGuest()
    {
        ...
        $response = $this->post('api/cms/v1/widgetFreeTextQuestion', $data);
    ...
    public function testUpdateForSuperAdmin(): void
    {
        ...
        $response = $this->put('api/cms/v1/widgetFreeTextQuestion/1?token=' . $token, self::UPDATE_DATA);
    ...
    public function testUpdateWrongDataForSuperAdmin(): void
    {
        ...
        $response = $this->put('api/cms/v1/widgetFreeTextQuestion/1?token=' . $token, self::UPDATE_DATA_INVALID);
    ...
    public function testUpdateWithWrongIdForSuperAdmin(): void
    {
        ...
        $response = $this->put('api/cms/v1/widgetFreeTextQuestion/99999999?token=' . $token, self::UPDATE_DATA);
    ...
    public function testUpdateForTenantAdmin(): void
    {
        ...
        $response = $this->put('api/cms/v1/widgetFreeTextQuestion/1token=' . $token, self::UPDATE_DATA);
    ...
    {
        $response = $this->put('api/cms/v1/widgetFreeTextQuestion/1?token', self::UPDATE_DATA);
    ...
    public function testReadForSuperAdmin()
    {
        ...
        $response = $this->get('api/cms/v1/widgetFreeTextQuestion/1?token=' . $token);
    ...
    public function testReadWithWrongIdForSuperAdmin()
    {
        ...
        $response = $this->get('api/cms/v1/widgetFreeTextQuestion/999999?token=' . $token);
    ...
    {
        // Response
        $response = $this->get('api/cms/v1/widgetFreeTextQuestion/1');
    ...
    public function testDeleteForSuperAdmin()
    {
        ...
        // Request
        $response = $this->delete('api/cms/v1/widgetFreeTextQuestion/1?token=' . $token);
    ...
    public function testDeleteWithWrongIdForSuperAdmin()
    {
        ...
        // Request
        $response = $this->delete('api/cms/v1/widgetFreeTextQuestion/99999?token=' . $token);
    ...
    {
        // Request
        $response = $this->delete('api/cms/v1/widgetFreeTextQuestion/2?token=');
